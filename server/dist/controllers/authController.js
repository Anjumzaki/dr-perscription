...
exports.resendVerificationEmail = exports.verifyEmail = exports.login = exports.register = void 0;
...
const register = async (req, res) => {
    try {
        ...
        try {
            await (0, emailService_1.sendVerificationEmail)(email, emailVerificationToken, name);
        }
        catch (emailError) {
...
const resendVerificationEmail = async (req, res) => {
    try {
        ...
        await user.save();
        await (0, emailService_1.sendVerificationEmail)(email, emailVerificationToken, user.name);
